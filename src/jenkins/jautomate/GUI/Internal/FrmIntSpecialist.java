...
/*
 * FrmIntSpecialist.java
 *
 * Created on Dec 19, 2013, 11:26:45 AM
 */
package jenkins.jautomate.GUI.Internal;
...
import jenkins.jautomate.Service.SpecialistService;
import jenkins.jautomate.TableModel.TableModelSpecialist;

/**
 *
 * @author Fachrul Pralienka BM
 */
public class FrmIntSpecialist extends javax.swing.JInternalFrame {

    SpecialistService ss = new SpecialistService();
    TableModelSpecialist tabelModelSpecialist = new TableModelSpecialist();
    Connection connection;

    /** Creates new form FrmIntSpecialist */
    public FrmIntSpecialist() {
        initComponents();
        tabelSpesialis.setModel(tabelModelSpecialist);
        tabelModelSpecialist.setData(ss.serviceGetAllSpecialist());

        // cek hasil hasilGetAll
        if (!SpecialistDao.hasilGetAll.equals("ok")) {
            JOptionPane.showMessageDialog(null, SpecialistDao.hasilGetAll, "Get All Specialist Gagal!", JOptionPane.ERROR_MESSAGE);
        }
        sesuaikan();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Specialist"));

        jLabel6.setText(":");

        jLabel5.setText(":");

        jLabel2.setText("Specialist Name");

        jLabel1.setText("Specialist ID");
        ...
        jLabel7.setText("Search specialist by Name or ID :");
    ...
    private void btnInsertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertActionPerformed
        ...
        String idSpecialist = txtIdSpesialis.getText();
        String nmSpecialist = txtNmSpesialis.getText();
        String tarifKonsul = txtTarifSpesialis.getText();

        if ((idSpecialist.equals("")) || (nmSpecialist.equals("")) || (tarifKonsul.equals("")) ){
            JOptionPane.showMessageDialog(null, "Data tidak boleh kosong!", "Insert Specialist Gagal!", JOptionPane.ERROR_MESSAGE);
        } else {
            Specialist s = new Specialist();
            s.setIdSpecialist(idSpecialist);
            s.setNmSpecialist(nmSpecialist);
            s.setPrice(Integer.parseInt(tarifKonsul));
            ss.serviceInsertSpecialist(s);

            if (SpecialistDao.hasilInsert.equals("ok")) {
                JOptionPane.showMessageDialog(null, "Data spesialis berhasil ditambah!", "Insert Specialist", JOptionPane.INFORMATION_MESSAGE);
                clear();
            } else {
                JOptionPane.showMessageDialog(null, SpecialistDao.hasilInsert, "Insert Specialist Gagal!", JOptionPane.ERROR_MESSAGE);
            }
        }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if ((nmSpecialist.equals("")) || (tarifKonsul.equals("")) ){
            JOptionPane.showMessageDialog(null, "Data tidak boleh kosong!", "Update Specialist Gagal!", JOptionPane.ERROR_MESSAGE);
        } else {
            Specialist s = new Specialist();
            s.setNmSpecialist(nmSpecialist);
            s.setPrice(Integer.parseInt(tarifKonsul));
            ...
            int row = tabelSpesialis.getSelectedRow();
            if (row != -1) {
                ss.serviceUpdateSpecialist(s, tabelSpesialis.getValueAt(row, 0).toString());

                if (SpecialistDao.hasilUpdate.equals("ok")) {
                    JOptionPane.showMessageDialog(null, "Data spesialis berhasil diubah!", "Update Specialist", JOptionPane.INFORMATION_MESSAGE);
                    clear();
                } else {
                    JOptionPane.showMessageDialog(null, SpecialistDao.hasilUpdate, "Update Specialist Gagal!", JOptionPane.ERROR_MESSAGE);
                }
            }
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (pilih == JOptionPane.OK_OPTION) {
            ...
            ss.serviceDeleteSpecialist(tabelSpesialis.getValueAt(row, 0).toString());

            if (SpecialistDao.hasilDelete.equals("ok")) {
                JOptionPane.showMessageDialog(null, "Data spesialis berhasil dihapus!", "Delete Specialist", JOptionPane.INFORMATION_MESSAGE);
                clear();
            } else {
                JOptionPane.showMessageDialog(null, SpecialistDao.hasilDelete, "Delete Specialist Gagal!", JOptionPane.ERROR_MESSAGE);
            }
    ...
    private void txtCariKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyReleased
        // TODO add your handling code here:
        tabelModelSpecialist.setData(ss.serviceGetAllSpecialistById(txtCari.getText()));
        if (tabelModelSpecialist.getRowCount() == 0) {
            tabelModelSpecialist.setData(ss.serviceGetAllSpecialistByNm(txtCari.getText()));
        }
        txtIdSpesialis.setText("");
        txtNmSpesialis.setText("");
        txtTarifSpesialis.setText("");
